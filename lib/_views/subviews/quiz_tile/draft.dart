...
import 'package:freequiz/_views/edit/quiz_draft/edit_draft.dart';
    ...
    return GestureDetector(
      ...
      child: Visibility(
        ...
        child: Dismissible(
          ...
          child: Container(
            height: context.mobileLayout ? context.screenHeight / 30 * 2.5 + 15 : context.screenHeight / 30 * 2.5 + 35,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  TileTitle(
                    title: QuizHelper.draft['title'] != "" ? QuizHelper.draft['title'] : context.tr('empty title'),
                    color: Colors.red,
                  ),
                  Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          QuizHelper.draft['description'].toString().truncate(32),

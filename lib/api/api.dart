...
Future<Map> httpPostSession(
    String username, String password, bool remember) async {
  final response = await http.post(
    Uri.parse('https://shadowcrafter.org/api/user/login'),
    headers: {
      "Authorization":
          "Bearer 3b589393da6bc000705e75c9ae2fec24442fe09bad96b1f31645f9813abc1924",
    },
...
Future<String> httpDeleteSession(String id) async {
  final http.Response response = await http.delete(
    Uri.parse('https://shadowcrafter.org/api/user/logout/'),
...
Future<Map> httpGetProfile(String id) async {
  final response = await http.get(
    Uri.parse('https://shadowcrafter.org/api/user/data'),
    headers: {
      "Authorization":
          "Bearer 3b589393da6bc000705e75c9ae2fec24442fe09bad96b1f31645f9813abc1924",
      "Session-token": id
...
Future<Map> httpPatchEmail(String id, String email) async {
  final response = await http.patch(
    Uri.parse('https://shadowcrafter.org/api/user/update/email'),
    headers: {
      "Authorization":
          "Bearer 3b589393da6bc000705e75c9ae2fec24442fe09bad96b1f31645f9813abc1924",
      "Session-token": id
...
Future<Map> httpPatchPassword(
    String id, String password, String passwordConfirmation) async {
  final response = await http.patch(
    Uri.parse('https://shadowcrafter.org/api/user/update/password'),
    headers: {
      "Authorization":
          "Bearer 3b589393da6bc000705e75c9ae2fec24442fe09bad96b1f31645f9813abc1924",
      "Session-token": id
...
Future<Map> httpPutAccount(String username, String email, String password,
  ...
  final response = await http.put(
    Uri.parse('https://shadowcrafter.org/api/user/create'),
    headers: {
      "Authorization":
          "Bearer 3b589393da6bc000705e75c9ae2fec24442fe09bad96b1f31645f9813abc1924",
    },
